      ...
      <Modal visible={reviewLoginOpen} transparent animationType="slide" onRequestClose={() => !reviewSigningIn && setReviewLoginOpen(false)}>
        <View style={styles.modalBackdrop}>
          <View style={styles.modalSheet}>
            ...
            <TextInput style={styles.productUrlInput} value={reviewEmail} onChangeText={setReviewEmail} placeholder="Correo de revisión" placeholderTextColor="#8A8A8A" autoCapitalize="none" autoCorrect={false} keyboardType="email-address" editable={!reviewSigningIn} />
            <TextInput style={styles.productUrlInput} value={reviewPassword} onChangeText={setReviewPassword} placeholder="Contraseña" placeholderTextColor="#8A8A8A" autoCapitalize="none" autoCorrect={false} secureTextEntry editable={!reviewSigningIn} onSubmitEditing={() => signInForAppReview().catch(() => undefined)} />
...
const styles = StyleSheet.create({
  ...
  noticeMessage: { color: "rgba(255,255,255,.82)", fontSize: 9, lineHeight: 13, marginTop: 3 },
  ...
  collectionTabText: { color: "#737373", fontSize: 12, fontWeight: "700" },
  ...
  homeIntro: { maxWidth: 290, color: "#D4D4D4", fontSize: 10, lineHeight: 16, marginTop: 10 },
  ...
  homeTodayCard: { minHeight: 96, flexDirection: "row", alignItems: "center", overflow: "hidden", borderWidth: 1, borderColor: line, borderRadius: 17, backgroundColor: "#FFFFFF" },
  homeTodayThumb: { width: 76, alignSelf: "stretch", backgroundColor: "#F4F4F4" },
  ...
  homeEmptyCalendar: { minHeight: 92, flexDirection: "row", alignItems: "center", paddingLeft: 15, marginBottom: 27, borderWidth: 1, borderColor: line, borderRadius: 17, backgroundColor: "#FFFFFF" },
  homeEmptyCalendarIcon: { width: 38, height: 38, color: rust, fontSize: 20, lineHeight: 36, textAlign: "center", borderRadius: 19, backgroundColor: "#F3F3F3" },
  ...
  homeLookVisual: { width: 128, height: 158, overflow: "hidden", borderRadius: 15, backgroundColor: "#F4F4F4" },
  homeLookName: { color: ink, fontSize: 9, fontWeight: "700", marginTop: 8 },
  homeEmptyLooks: { alignItems: "center", padding: 28, borderWidth: 1, borderStyle: "dashed", borderColor: line, borderRadius: 18, backgroundColor: "#FFFFFF" },
  ...
  profileLibrary: { overflow: "hidden", borderWidth: 1, borderColor: line, borderRadius: 20, backgroundColor: "#FFFFFF" },
  ...
  wishlistEmpty: { alignItems: "center", marginTop: 12, paddingHorizontal: 26, paddingVertical: 48, borderWidth: 1, borderStyle: "dashed", borderColor: line, borderRadius: 20, backgroundColor: "#FFFFFF" },
  ...
  batchBannerError: { borderColor: "#E5E5E5", backgroundColor: "#FFF5F5" },
  ...
  emptyCollection: { alignItems: "center", marginTop: 34, paddingHorizontal: 26, paddingVertical: 34, borderWidth: 1, borderStyle: "dashed", borderColor: line, backgroundColor: "#FFFFFF" },
  ...
  outfitCollage: { position: "relative", width: "100%", aspectRatio: 0.72, overflow: "hidden", backgroundColor: "#F4F4F4" },
  outfitVisualLayer: { position: "absolute", left: 0, right: 0, top: 0, bottom: 0 },
  outfitCollageCell: { position: "absolute", width: "50%", height: "50%", alignItems: "center", justifyContent: "center", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(229,229,229,.72)" },
  ...
  bottomNav: { position: "absolute", left: 32, right: 32, bottom: Platform.OS === "ios" ? 16 : 12, height: 76, flexDirection: "row", justifyContent: "space-evenly", alignItems: "center", borderWidth: StyleSheet.hairlineWidth, borderColor: "rgba(229,229,229,.72)", borderRadius: 39, backgroundColor: "#FFFFFF", shadowColor: "#000", shadowOpacity: .14, shadowRadius: 24, shadowOffset: { width: 0, height: 10 }, elevation: 12 },
  navItem: { flex: 1, height: 68, alignItems: "center", justifyContent: "center", gap: 3 },
  navIcon: { color: "#8A8A8A", fontSize: 20 },
  navLabel: { color: "#8A8A8A", fontSize: 9 },
  ...
  webTryOnBanner: { flexDirection: "row", alignItems: "center", gap: 11, marginBottom: 14, paddingHorizontal: 12, paddingVertical: 11, borderWidth: 1, borderColor: "#E5E5E5", borderRadius: 14, backgroundColor: "#FFFFFF" },
  ...
  tryOnRailItem: { width: 78, overflow: "hidden", borderWidth: 1, borderColor: line, borderRadius: 8, backgroundColor: "#FFFFFF" },
  ...
  tryOnCanvas: { position: "relative", width: "100%", height: 492, overflow: "hidden", borderWidth: 1, borderColor: line, borderRadius: 20, backgroundColor: "#F4F4F4" },
  ...
  avatarPlaceholder: { position: "absolute", left: 34, right: 34, top: 84, bottom: 84, alignItems: "center", justifyContent: "center", borderWidth: 1, borderStyle: "dashed", borderColor: "#D4D4D4", borderRadius: 140, backgroundColor: "rgba(255,255,255,.82)" },
  ...
  bodyDropZoneText: { color: rust, fontSize: 7, fontWeight: "900", letterSpacing: 0.8, paddingHorizontal: 8, paddingVertical: 5, borderRadius: 12, backgroundColor: "rgba(255,255,255,.88)" },
  bodyDropZoneTextReady: { color: "#52604D", backgroundColor: "rgba(247,249,244,.92)" },
  tryOnRenderingOverlay: { position: "absolute", zIndex: 40, left: 0, right: 0, top: 0, bottom: 0, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(244,244,244,.78)" },
  tryOnRenderingCard: { width: 230, alignItems: "center", paddingHorizontal: 24, paddingVertical: 23, borderRadius: 20, borderWidth: 1, borderColor: "rgba(163,79,49,.22)", backgroundColor: "rgba(255,255,255,.96)" },
  ...
  tryOnHintText: { color: rust, fontSize: 7, fontWeight: "800", letterSpacing: 1.2, marginTop: 4, paddingHorizontal: 9, paddingVertical: 6, borderRadius: 12, backgroundColor: "rgba(255,255,255,.86)" },
  ...
  tryOnControls: { minHeight: 59, flexDirection: "row", alignItems: "center", gap: 7, marginTop: 10, paddingHorizontal: 11, paddingVertical: 9, borderWidth: 1, borderColor: line, borderRadius: 14, backgroundColor: "#FFFFFF" },
  ...
  tryOnDeleteButton: { borderColor: "#E5E5E5", backgroundColor: "#FFF5F5" },
  tryOnDeleteButtonText: { color: rust, fontSize: 21, lineHeight: 23, fontWeight: "300" },
  tryOnSelectionPanel: { marginTop: 10, padding: 11, borderWidth: 1, borderColor: line, borderRadius: 14, backgroundColor: "#FFFFFF" },
  tryOnSelectionHeading: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 8 },
  tryOnQualityBadge: { color: rust, fontSize: 6, fontWeight: "800", letterSpacing: 0.8, paddingHorizontal: 7, paddingVertical: 5, borderRadius: 10, backgroundColor: "#F3F3F3" },
  tryOnSelectionChips: { flexDirection: "row", flexWrap: "wrap", gap: 6, marginTop: 8 },
  tryOnSelectionChip: { flexDirection: "row", alignItems: "center", gap: 7, paddingLeft: 10, paddingRight: 7, paddingVertical: 7, borderRadius: 18, borderWidth: 1, borderColor: "#D4D4D4", backgroundColor: paper },
  ...
  generateTryOnOutfitButtonText: { color: "#FFFFFF", fontSize: 9, fontWeight: "800", letterSpacing: 0.2 },
  ...
  wardrobeDragGhost: { position: "absolute", zIndex: 200, width: 86, height: 86, padding: 5, borderRadius: 18, borderWidth: 2, borderColor: rust, backgroundColor: "rgba(255,255,255,.95)", shadowColor: "#000", shadowOpacity: 0.18, shadowRadius: 10, shadowOffset: { width: 0, height: 5 } },
  wardrobeDragGhostReady: { borderColor: "#71826A", transform: [{ scale: 1.08 }] },
  wardrobeDragGhostImage: { width: "100%", height: "100%" },
  builderPanel: { backgroundColor: "#FFFFFF", padding: 17, borderWidth: 1, borderColor: line },
  ...
  generateButtonText: { color: "#FFFFFF", fontSize: 10, fontWeight: "800", letterSpacing: 0.3 },
  lookCard: { flex: 1, marginBottom: 14, backgroundColor: "#F2F2F2" },
  lookCopy: { padding: 10, backgroundColor: "#FFFFFF" },
  ...
  plannerRoundButton: { width: 48, height: 48, alignItems: "center", justifyContent: "center", borderRadius: 24, backgroundColor: "#FFFFFF", shadowColor: "#000", shadowOpacity: .06, shadowRadius: 12, shadowOffset: { width: 0, height: 5 } },
  ...
  plannerTodayButton: { minWidth: 66, height: 48, alignItems: "center", justifyContent: "center", paddingHorizontal: 15, borderRadius: 24, backgroundColor: "#FFFFFF", shadowColor: "#000", shadowOpacity: .06, shadowRadius: 12, shadowOffset: { width: 0, height: 5 } },
  ...
  plannerModeText: { color: "#737373", fontSize: 13, fontWeight: "700" },
  ...
  plannerWeekdayName: { color: "#8A8A8A", fontSize: 9, fontWeight: "600", marginBottom: 7 },
  ...
  plannerOutfitCard: { position: "relative", minHeight: 470, alignItems: "center", justifyContent: "center", overflow: "hidden", marginHorizontal: 16, borderWidth: StyleSheet.hairlineWidth, borderColor: line, borderRadius: 22, backgroundColor: "#FFFFFF", shadowColor: "#000", shadowOpacity: .08, shadowRadius: 18, shadowOffset: { width: 0, height: 8 }, elevation: 6 },
  ...
  plannerOutfitVisual: { flex: 1, minHeight: 390, backgroundColor: "#F2F2F2" },
  plannerOutfitFooter: { minHeight: 80, flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingLeft: 17, backgroundColor: "#FFFFFF" },
  ...
  plannerMonthDateOutside: { color: "#D4D4D4" },
  plannerMonthDateSelected: { color: "#FFF", fontWeight: "900" },
  plannerMonthSlot: { flex: 1, width: "100%", alignItems: "center", justifyContent: "center", borderRadius: 7, backgroundColor: "#F2F2F2" },
  plannerMonthSlotOutside: { backgroundColor: "transparent" },
  plannerMonthSlotScheduled: { overflow: "hidden", backgroundColor: "#F2F2F2" },
  ...
  plannerMonthOutfitPreview: { position: "absolute", left: 0, right: 0, top: 0, bottom: 0, overflow: "hidden", backgroundColor: "#F2F2F2" },
  ...
  plannerCostHint: { color: "#8A8A8A", fontSize: 7, textAlign: "center", marginTop: 16 },
  calendarPanel: { overflow: "hidden", padding: 10, borderWidth: 1, borderColor: line, borderRadius: 20, backgroundColor: "#FFFFFF" },
  ...
  calendarAgendaCard: { position: "relative", flexDirection: "row", overflow: "hidden", minHeight: 104, borderWidth: 1, borderColor: line, borderRadius: 16, backgroundColor: "#FFFFFF" },
  calendarAgendaOpen: { flex: 1, flexDirection: "row", alignItems: "center" },
  calendarAgendaThumb: { width: 74, alignSelf: "stretch", backgroundColor: "#F4F4F4" },
  ...
  calendarEmpty: { minHeight: 150, alignItems: "center", justifyContent: "center", padding: 24, borderWidth: 1, borderStyle: "dashed", borderColor: line, borderRadius: 18, backgroundColor: "#FFFFFF" },
  ...
  calendarPickerCard: { minHeight: 95, flexDirection: "row", alignItems: "center", overflow: "hidden", borderWidth: 1, borderColor: line, borderRadius: 15, backgroundColor: "#FFFFFF" },
  calendarPickerThumb: { width: 68, alignSelf: "stretch", backgroundColor: "#F4F4F4" },
  ...
  calendarQuickDate: { width: "22.5%", minHeight: 72, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: line, borderRadius: 15, backgroundColor: "#FFFFFF" },
  ...
  outfitPieceList: { marginTop: 12, marginBottom: 14, padding: 12, gap: 5, borderWidth: 1, borderColor: line, borderRadius: 12, backgroundColor: "#FFFFFF" },
  ...
  createMenuAction: { minHeight: 82, flexDirection: "row", alignItems: "center", paddingHorizontal: 13, marginBottom: 9, borderWidth: 1, borderColor: line, borderRadius: 18, backgroundColor: "#FFFFFF" },
  ...
  scanOrb: { width: 58, height: 58, marginBottom: 20, alignSelf: "center", alignItems: "center", justifyContent: "center", borderRadius: 29, borderWidth: 1, borderColor: line, backgroundColor: "#FFFFFF" },
  ...
  webImportChoice: { flexDirection: "row", alignItems: "center", gap: 10, marginTop: 16, padding: 12, borderWidth: 1, borderColor: "#E5E5E5", borderRadius: 13, backgroundColor: "#FFFFFF" },
  ...
  photoPicker: { height: 91, marginTop: 16, marginBottom: 12, alignItems: "center", justifyContent: "center", borderWidth: 1, borderStyle: "dashed", borderColor: "#D4D4D4", backgroundColor: "#FFFFFF" },
  ...
  photoCell: { position: "relative", width: "31.8%", aspectRatio: 1, overflow: "hidden", backgroundColor: "#F4F4F4" },
  ...
  productUrlInput: { minHeight: 52, marginTop: 6, paddingHorizontal: 14, paddingVertical: 12, borderWidth: 1, borderColor: "#D4D4D4", borderRadius: 12, backgroundColor: "#FFFFFF", color: ink, fontSize: 10 },
  ...
  productPlacementChip: { paddingHorizontal: 11, paddingVertical: 8, borderWidth: 1, borderColor: line, borderRadius: 16, backgroundColor: "#FFFFFF" },
  ...
  premiumCard: { flexDirection: "row", alignItems: "center", gap: 11, marginTop: 18, padding: 13, borderWidth: 1, borderColor: "#E5E5E5", borderRadius: 15, backgroundColor: "#FFFFFF" },
  ...
  currentAvatarCard: { flexDirection: "row", alignItems: "center", gap: 14, marginTop: 6, marginBottom: 18, padding: 10, borderWidth: 1, borderColor: line, borderRadius: 15, backgroundColor: "#FFFFFF" },
  currentAvatarImage: { width: 70, height: 94, borderRadius: 10, backgroundColor: "#F4F4F4" },
  ...
  avatarReferenceCard: { flex: 1, minHeight: 190, overflow: "hidden", borderWidth: 1, borderStyle: "dashed", borderColor: "#D4D4D4", borderRadius: 15, backgroundColor: "#FFFFFF" },
  ...
  avatarConsentRow: { flexDirection: "row", alignItems: "flex-start", gap: 10, marginTop: 16, padding: 12, borderRadius: 12, backgroundColor: "#FFFFFF" },
  avatarConsentBox: { width: 21, height: 21, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "#A3A3A3", borderRadius: 5, backgroundColor: paper },
  ...
  editGarmentButton: { marginTop: 3, paddingHorizontal: 15, paddingVertical: 9, borderRadius: 18, borderWidth: 1, borderColor: line, backgroundColor: "#FFFFFF" },
  ...
  metadataSeparator: { color: "#A3A3A3", fontSize: 9 },
  metadataTags: { flexDirection: "row", flexWrap: "wrap", gap: 6, marginTop: 9 },
  metadataTag: { paddingHorizontal: 9, paddingVertical: 6, borderRadius: 14, backgroundColor: "#F4F4F4" },
  ...
  editorInput: { minHeight: 46, paddingHorizontal: 13, paddingVertical: 11, borderWidth: 1, borderColor: line, borderRadius: 13, backgroundColor: "#FFFFFF", color: ink, fontSize: 11 },
  editorCategoryGrid: { flexDirection: "row", flexWrap: "wrap", gap: 7 },
  editorCategory: { paddingHorizontal: 12, paddingVertical: 9, borderWidth: 1, borderColor: line, borderRadius: 17, backgroundColor: "#FFFFFF" },
  ...
  editorCancelButton: { flex: 1, minHeight: 47, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: line, borderRadius: 24, backgroundColor: "#FFFFFF" },

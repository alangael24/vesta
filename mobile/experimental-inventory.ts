...
Classify dresses, jumpsuits, rompers, overalls, monos and enterizos as one_piece; skirts as bottoms; blouses and bodysuits as tops; coats and cardigans as layers; and clearly visible handbags, jewelry, scarves and belts as accessories. These categories apply equally to feminine, masculine and unisex wardrobes.
...
Preserve the person's identity, face, hair, skin tone, body shape and proportions, standing pose, hands, feet, camera angle, framing, and lighting from Image 1. Replace the background with perfectly flat pure white RGB 255,255,255, edge to edge, with no warm tint, gradient, texture, horizon, floor seam, or vignette. Preserve each garment's real color, silhouette, material cues, graphics, logos, patterns, trim, pockets, and construction exactly as supported by its reference image. Do not invent or alter branding. Do not show any floating garment, catalog cutout, duplicated clothing, mannequin, hanger, phone, text, extra person, extra limb, or extra object. Output only the finished full-body portrait.`;
